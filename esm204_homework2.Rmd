...
# step 3: find the total cost to each district (using new abatement level and tax)
...
# step 5: sum each district cost to find the total cost 
total_cost_tax_300 <- (kern_cost_tax_300 + mojave_cost_tax_300 + antelope_cost_tax_300 + ventura_cost_tax_300)
...
The total cost to each district under this tax policy is: 
  ...
  - Kern: $`r round(kern_cost_tax_300, 0)`

  - Mojave: $`r round(mojave_cost_tax_300, 0)`

  - Antelope: $`r round(antelope_cost_tax_300, 0)`

  - Ventura: $`r round(ventura_cost_tax_300, 0)`

### **Policy C - Cap and Trade**

The equimarginal principle tells us that units will be bought and sold at the same tax rate as calculated in Policy B ($282.04). Therefore, the total cost of meeting the 300 AF abatement target using a Cap and Trade policy will be the same as the cost under the Tax policy,  $64,164.34. 
