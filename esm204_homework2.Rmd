...
```
(1) Each district has to reduce `r round(a_stringency, 3)`% from their starting baseline to reach the abatement target of 500 AF.  
...
```
(1) The stringency under this policy is a `r round(tax_target, 2)`
