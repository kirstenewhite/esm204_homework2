...
- The total cost to each district under this cap with no trade policy is: 
...
```
- The stringency under this policy is a `r round(tax_target, 2)`
...
- Total tax revenue generated is: 
