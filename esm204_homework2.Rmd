...
kern_abate <- (a_stringency * Eo_kern)
kern_new_q <- (Eo_kern - kern_abate)
kern_new_p <- ()
...
- Kern needs to abate by `r kern_abate` (50.7 units) from the baseline of 150 `r Eo_kern`; cost to abate at the new Q (of 99.3): y (P* ) = 343.5 - 2.29 (99.3) =  115.20; therefore the total cost to abate is the area under the curve = (1/2 * 50.7 * 115.20) = 
$2,920.32
